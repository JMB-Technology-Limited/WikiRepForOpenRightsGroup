 ...
 */
class API1ProjectDirectoryRecordControllerFieldBooleanWithDataBaseTest extends BaseTestWithDataBase {
    ...
    function testWithLocale() {
        ...
        $recordHasFieldBooleanValue = new RecordHasFieldBooleanValue();
        $recordHasFieldBooleanValue->setRecord($record);
        $recordHasFieldBooleanValue->setField($field);
        $recordHasFieldBooleanValue->setValue(true);
        $recordHasFieldBooleanValue->setApprovedAt(new \DateTime());
        $recordHasFieldBooleanValue->setCreationEvent($event);
        $recordHasFieldBooleanValue->setApprovalEvent($event);
        $this->em->persist($recordHasFieldBooleanValue);
        ...
        $this->assertEquals(true, $data['fields']['cool']['value']['value']);
